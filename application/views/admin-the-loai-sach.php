	...
	<div class="menu-box py-5">
		<div class="container">
			...
			<form action="http://php-quoc.epizy.com/Crud/tim_kiem_theo_the_loai" method="post">
			...
			<!-- /Tim kiem sach -->
			<div class="container bg-warning text-center py-3">
                <div class="row">
                    <div class="col">
                    ...
                    <div class="col">
                        <a href="http://php-quoc.epizy.com/Crud/mh_them_the_loai" class="btn btn-danger"> THÊM THỂ LOẠI SÁCH</a>
                    </div> 
                    <div class="col">
                        <a href="http://php-quoc.epizy.com/Crud/crud_admin" class="btn btn-danger"> QUẢN LÝ SÁCH</a>
                    </div>                   
                </div>
                                    ...
                                    if(!isset($_GET["mtl"])){
                                        foreach($loaiSach as $row){
                                            ...
                                            <div class='gallery-single fix'>
                                                <img src='{$row -> url_the_loai}'  style='width: 300px; height:350px;' class='img-fluid' alt='{$row -> url_the_loai}'>
                                                <div class='why-text'>
                                                    <h4> Mã thể loại: {$row-> Id}</h4>
                                                    <h5>Tên Thể loại: {$row-> TenTheloaiSach}</h5>
                                                    <div class='row'>
                                                        <div class='col'>
                                                            <a class='btn btn-primary' href='http://php-quoc.epizy.com/Crud/sua_the_loai?tl={$row->Id}'>Sửa</a>                                                            
                                                        </div>
                                                        <div class='col'>
                                                            <a class='btn btn-danger' href='http://php-quoc.epizy.com/Crud/mh_xoa_the_loai?tl={$row->Id}'>Xóa</a>                                                            
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
