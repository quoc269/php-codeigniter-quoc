 ...
 <div class="container">
    ...
    <div class="btn-group">
        ...
        <div class="dropdown-menu">
            <button type="button" class="dropdown-item btn " data-toggle="modal" data-target="#myModalAdmin">
                Admin
            </button>
            <button type="button" class="dropdown-item btn" data-toggle="modal" data-target="#myModalKhach">
                Khách hàng
            </button>
        </div>
    </div>
        ...
        <!-- The Modal admin  -->
        <div class="modal" id="myModalAdmin"  data-backdrop="false">
              ...
              <div class="modal-body">
                <form action="http://php-quoc.epizy.com/Crud/xl_login_admin" method="post">
                    <div class="imgcontainer text-center">
                      <img src="../../images/quoc-avatar.jpg" style="width:200px; height:200px;" alt="Avatar" class="rounded-circle">
                    </div>
