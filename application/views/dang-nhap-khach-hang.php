...
<form action="http://php-quoc.epizy.com/Crud/xl_dang_nhap_khach_hang" method="post">
  ...
  <div class="py-5">
      <h2 class="text-danger">Quý khách vui lòng đăng nhập hoặc đăng ký thành viên để thuê sách</h2>
  </div>
  ...
  <div class="container" style="background-color:#f1f1f1">
    <a href="http://php-quoc.epizy.com/Crud/dang_ky" class="btn cancelbtn">ĐĂNG KÝ </a>
