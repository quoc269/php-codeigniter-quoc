                                ...
                                $Chuoi_HTML_Sach = "";
                                 foreach($TheLoaiSua as $row){
                                    ...
                                    <div class='gallery-single fix'>
                                        ...
                                        <div class='why-text'>
                                            <form action='http://php-quoc.epizy.com/Crud/xoa_the_loai_sach' method='post'>   
                                            <h1 class='text-danger'>XÓA THỂ LOẠI SÁCH CỦA ADMIN </h1>   
                                            ...
                                            <input type='submit' name='btnXoa' value='XÓA' class='btn btn-primary form-control'>
