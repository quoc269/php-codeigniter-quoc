					...
					<div class="tab-content" id="v-pills-tabContent">
						<div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                    ...
                                    <?php 
                                        ...
                                        foreach($gioHang as $k=>$v){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href='http://php-quoc.epizy.com/Crud/huy_sach?ms={$gioHang[$k]['id']}' class='btn-warning btn-sm'>HỦY</a>
                                                </td>                                               
                                            </tr>         
                                            ";
                                            $stt++;
                            ...
                            <div class="container text-right">
                                       <a href="http://php-quoc.epizy.com/Crud/thanh_toan" class="btn btn-primary btn-lg">THANH TOÁN</a>
                            </div>
						</div>
